...
class ThreeLayerConvNet(object):
  ...
  def loss(self, X, y=None):
    ...
    h1, cache1 = conv_relu_pool_forward(X, self.params['W1'], self.params['b1'], conv_param, pool_param)
    h2, cache2 = affine_relu_forward(h1, self.params['W2'], self.params['b2'])
    scores,cache3 = affine_forward(h2, self.params['W3'], self.params['b3'])
    ...
    dreg = self.reg * 0.5 * (np.sum(self.params['W1']**2) + np.sum(self.params['W2']**2) + np.sum(self.params['W3']**2))
    loss += dreg
